...
export declare const TENANT_PROVISIONING_QUEUE = "tenant-provisioning";
/** Cola de purga diaria de refresh tokens expirados */
export declare const REFRESH_TOKEN_PURGE_QUEUE = "refresh-token-purge";
/** Cola de purga fisica diferida de schemas de tenants marcados para eliminacion */
export declare const TENANT_SCHEMA_PURGE_QUEUE = "tenant-schema-purge";
/** Cola transversal para indexación de búsqueda global en Typesense */
export declare const SEARCH_INDEX_QUEUE = "search-index";
/** Cola de despacho a campo originada desde Service Assurance */
export declare const ASSURANCE_FIELD_SERVICE_QUEUE = "assurance-field-service";
