...
__decorate(
  [
    (0, typeorm_1.Column)({
      type: 'enum',
      enum: shared_1.StockBalanceCondition,
      enumName: 'stock_balance_condition',
      default: shared_1.StockBalanceCondition.NEW,
    }),
...
exports.StockBalance = StockBalance = __decorate(
  [
    ...
    (0, typeorm_1.Index)('idx_stock_balances_tenant_location_item', [
      'tenantId',
      'locationId',
      'itemId',
    ]),
    (0, typeorm_1.Entity)({ name: 'stock_balances' }),
  ],
  StockBalance,
);
