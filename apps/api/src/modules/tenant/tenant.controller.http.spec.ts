...
describe('TenantController HTTP', () => {
  ...
  const provisioningService = { enqueue: jest.fn(), retryProvisioning: jest.fn() };
  const authService = {
  ...
  it('PATCH /api/v1/tenants/:id/retry-provisioning retorna el tenant en PROVISIONING', async () => {
    ...
    provisioningService.retryProvisioning.mockResolvedValue({
      id: '44444444-4444-4444-8444-444444444444',
      slug: 'isp-test',
      schemaName: 'tenant_isp_test',
      status: 'PROVISIONING',
    ...
    const response = await request(app.getHttpServer())
      .patch('/api/v1/tenants/44444444-4444-4444-8444-444444444444/retry-provisioning')
      .set('Authorization', 'Bearer platform-admin-token')
      .expect(200);
