    ...
    <div className="relative">
      ...
      >
        <span className="hidden text-right lg:block">
          ...
          <span className="block text-xs text-gray-500 dark:text-gray-400">System Admin</span>
        </span>
      ...
      >
        <div className="px-4 py-3 border-b border-gray-100 dark:border-gray-700">
          <span className="block text-sm font-medium text-gray-800 dark:text-white">Administrador</span>
          <span className="block text-xs text-gray-500 dark:text-gray-400">admin@iwana.com</span>
        </div>
