...
export function PlatformLoginExperience({ variant = 'premium' }: PlatformLoginExperienceProps) {
  ...
  return (
    <main
      className="relative min-h-screen overflow-hidden bg-[#0F1325]"
    ...
    >
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-4 py-6 sm:px-6 lg:px-10 lg:py-10">
        <section
          data-testid="platform-login-shell"
          ...
          <div className="grid min-h-[650px] grid-cols-1 lg:grid-cols-[0.95fr_1.05fr]">
            <aside className={asideClassName}>
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-lg bg-[#A5C330] text-[#181818]">
              ...
              <div className="my-auto">
                ...
                <h1
                  className={`${variant === 'premium' ? 'text-5xl' : 'text-[2.65rem]'} max-w-xl font-bold leading-tight tracking-tight`}
                >
                ...
                <p className="mt-6 max-w-md text-base leading-relaxed text-slate-300">
                  Autenticación segura, trazabilidad activa y gobierno centralizado para la
            ...
            <div className="relative flex items-center justify-center p-4 sm:p-6 lg:p-10">
              <div
                className={`${FORM_PANEL_PREMIUM_CLASS} relative w-full max-w-[560px] lg:max-w-[520px]`}
              >
                <div className="mb-10">
                  <div className="mb-6 flex items-center gap-2 lg:hidden">
                    <div className="flex h-8 w-8 items-center justify-center overflow-hidden rounded-lg bg-[#A5C330]">
                      <img
                        src={logoUrl}
                        alt=""
                    ...
                    <span className="font-bold text-[#181818]">{branding.productName}</span>
                  </div>
                  ...
                  <p className="text-base text-slate-500 dark:text-gray-400">
                    Ingresa tus credenciales para administrar empresas, usuarios y operación
                    interna.
                  </p>
                </div>
