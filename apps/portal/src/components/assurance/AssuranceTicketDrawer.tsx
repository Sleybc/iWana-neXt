    ...
    <>
      <ModalLayer align="end" onVeilClick={onClose}>
        <aside
          className={cn(
            overlayEdgeClassName,
            'pointer-events-auto relative flex h-full w-full max-w-3xl flex-col border-l bg-white shadow-2xl dark:bg-dark-surface-2',
          )}
        >
          <div className="flex items-start justify-between gap-4 border-b border-gray-100 px-6 py-5 dark:border-dark-border">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {ticket?.subject ??
                  'Consulta comentarios, timeline y acciones operativas del caso.'}
              </p>
            </div>
                  ...
                  <TabsContent value="actions" className="space-y-5">
                    ...
                    {canOperate && !terminal && onCreateLinkedTask ? (
                      <section className="rounded-2xl border border-gray-200 bg-[#fbfcf8] p-4 dark:border-dark-border dark:bg-dark-surface-3">
                        ...
                        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                          Registra una tarea operativa asociada a este ticket sin crear una visita
                          de forma automática.
                        </p>
                        <div className="mt-4">
