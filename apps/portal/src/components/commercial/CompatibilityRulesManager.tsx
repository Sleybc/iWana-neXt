    ...
    <Card className="rounded-[28px] border border-white/70 shadow-iwana-card dark:border-dark-border dark:bg-dark-surface-2/95">
      ...
      <CardContent>
        {isLoading ? (
          ...
          <div className="rounded-[24px] border border-dashed border-gray-300 px-4 py-8 text-center dark:border-dark-border">
            <ArrowRight
              className="mx-auto mb-3 h-8 w-8 text-gray-300 dark:text-gray-600"
              aria-hidden="true"
            />
            <p className="text-sm text-gray-600 dark:text-gray-300">
              No hay reglas de reemplazo configuradas. Crea la primera regla para guiar a los
              agentes cuando sugieran ítems obsoletos.
            </p>
          </div>
        ) : (
