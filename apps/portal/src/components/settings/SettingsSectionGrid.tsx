...
const iconMap: Partial<Record<SettingsSectionKey, typeof Building2>> = {
  ...
  [SettingsSectionKey.RULES]: Scale,
...
function sortSectionPresentations(sections: SettingsSectionPresentation[]) {
  const order: Record<SettingsSectionKey, number> = {
    ...
    [SettingsSectionKey.RULES]: 3,
    [SettingsSectionKey.BRANDING]: 4,
    [SettingsSectionKey.FIELD_OPERATIONS]: 5,
    [SettingsSectionKey.COMMERCIAL]: 6,
    [SettingsSectionKey.BILLING]: 7,
    [SettingsSectionKey.INVENTORY]: 8,
    [SettingsSectionKey.INTEGRATIONS]: 9,
  };
