 ...
 *
 * Se muestra cuando un suscriptor o usuario del tenant inicia sesion con
 * credenciales temporales asignadas por el administrador (passwordResetRequired=true).
 *
...
export default function ChangePasswordPage() {
  ...
  return (
    ...
    >
      <LoginBrandPanel
        title="Tu Seguridad"
        subtitle="Debes establecer una nueva contrasena antes de acceder al portal. Elige una contrasena segura y unica."
      />
        ...
        <div className="w-full max-w-[480px] bg-white rounded-2xl p-8 lg:p-12 shadow-2xl relative z-10">
          <div className="mb-10">
            ...
            <p className="text-slate-500 text-base">
              Establece una contrasena segura para acceder al portal
            </p>
          </div>
            ...
            <label className="flex flex-col gap-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  placeholder="Contrasena temporal recibida"
