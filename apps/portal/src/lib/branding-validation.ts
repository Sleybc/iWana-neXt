...
/**
 * Reglas estrictas por slot para evitar distorsión visual en branding tenant.
 * Se mantienen alineadas con las validaciones backend de MediaService.
 */
...
export async function validateBrandingFileForUpload(
  ...
  // Algunos navegadores no decodifican ICO en el objeto Image; backend valida en forma autoritativa.
