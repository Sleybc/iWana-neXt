...
- Reutilizar `PortalPanel`, `PortalSectionHeader`, `PortalActionToolbar`, `PortalAlert` y `PortalEmptyState` antes de crear variantes locales. Si un patron se repite en dos pantallas, promoverlo a primitive o utility compartida.
