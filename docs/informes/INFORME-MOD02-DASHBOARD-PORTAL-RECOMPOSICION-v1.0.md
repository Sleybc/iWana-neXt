...
| A — backend | AI-SR-FULL | A-1…A-4 | Hecho | jest `tenant-self.spec.ts` 17/17 · typecheck `@iwana/api` exit 0 · C-1/C-2/C-3 · SHA en bitácora |
...
| 2026-08-10 | A-1…A-4 | AI-SR-FULL | Hecho | jest 17/17 · typecheck 0 · `DashboardSummaryTenantDto` · mfaCoverage real · fiber default 50 | Track A cerrado; sin endpoints nuevos ni ampliación `@Roles`; MFA 0 usuarios → ratio `1` |
