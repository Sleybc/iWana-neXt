...
- En tablas de datos y listados tabulares, la alineación vertical base de las celdas debe ser `align-middle`; `align-top` queda reservado para casos deliberados con contenido apilado que necesite anclaje superior.
