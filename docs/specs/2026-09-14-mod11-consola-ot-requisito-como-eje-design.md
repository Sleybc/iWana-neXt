...
- **CA-13** — `audit-ui.mjs` limpio sobre los archivos tocados. *(Ruta precisada el 2026-09-14 tras la consolidación: el script vive en `.agents/skills/iwana-identity-ui-review/scripts/audit-ui.mjs` y no tiene alias en `package.json`; la v1.0 lo citaba por nombre suelto, heredando la imprecisión de la spec del 2026-09-13.)*
