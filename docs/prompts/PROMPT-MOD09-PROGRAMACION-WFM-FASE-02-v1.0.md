...
- PRD canonico del modulo: docs/prds/PRD-MOD09-PROGRAMACION-WFM-v1.0.md
...
1. Leer PRD canonico consolidado, HLD, spec, plan e informe previo antes de tocar codigo.
