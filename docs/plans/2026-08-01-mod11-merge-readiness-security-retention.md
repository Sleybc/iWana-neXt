...
**Contrato:** documento de gates G6.5 [ADR-069](../adrs/ADR-069-Gates-G6.5-Merge-Readiness.md) — Aprobado 2026-08-02
...
- CI #112 sobre `1343d6b8`: `production-images` y `execution-orders-e2e` verdes en
