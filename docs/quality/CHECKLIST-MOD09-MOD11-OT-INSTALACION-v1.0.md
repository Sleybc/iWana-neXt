...
- [x] G6.5 Merge readiness: CI #111 certifica `production-images` y `execution-orders-e2e` verdes en Linux sobre `5eb93842`.
...
**Veredicto actual:** G6 **GO**; G6.5 **GO** tras CI Linux real sobre `5eb93842`; G7 **NO-GO** para producción. Los seis P0 históricos están remediados y registrados en §7.5. TLS, rollback, restores y aprobación CTO siguen siendo requisitos de G7.
