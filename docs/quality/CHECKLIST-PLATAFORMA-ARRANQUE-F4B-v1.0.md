...
- [ ] **Disparador de ADR-070 (superado) activado**
...
- [ ] Marcadores de dominio intactos, o resueltos conforme a lo que determine ADR-070 (superado) *(CA-F4B-10)*
- [ ] **No se definió dominio, hosting, autoridad certificadora ni objetivos de recuperación** — es del CTO vía ADR-070 (superado)
