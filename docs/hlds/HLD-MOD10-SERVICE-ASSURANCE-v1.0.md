...
**Spec de origen:** docs/specs/2026-05-09-mod10-hallazgos-design.md  
**ADR propuesto:** docs/adrs/ADR-038-Bounded-Context-Service-Assurance.md  
**ADR complementario propuesto:** docs/adrs/ADR-046-Bounded-Context-Tasks-Ejecucion-Operativa.md  
...
| `TasksModule` futuro | Downstream/neighbor | Owner propuesto de tareas ejecutables; Assurance solo origina o vincula tareas |
...
- Assurance no es owner de tareas ejecutables transversales; si un caso deriva en trabajo concreto, debe originar o vincular la tarea por contrato aprobado.
...
11. El estado del ticket no debe duplicar el estado fino de una tarea operativa futura; ticket y tarea representan ownership distintos.
